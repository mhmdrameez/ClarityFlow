import { Activity, Play, Pause, RefreshCw, Trash } from 'lucide-react';
...
export function MeditationTracker({ sessions, logMeditation, deleteSession }: MeditationTrackerProps) {
                ...
                <div className="space-y-6">
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex flex-col items-center space-y-3 my-8">
                            <div
                                className={`rounded-full bg-blue-500 transition-all duration-1000 ease-in-out ${isBreathingIn ? 'w-24 h-24' : 'w-16 h-16'
                                    }`}
                            />
                        ...
                        {todaySessions
                            ...
                            .map(session => (
                                <div key={session.id} className="p-3 border rounded-lg flex justify-between items-center">
                                    <div>
                                        <span>{session.duration} minute{session.duration !== 1 ? 's' : ''}</span><br />
                                        <span className="text-sm text-muted-foreground">
