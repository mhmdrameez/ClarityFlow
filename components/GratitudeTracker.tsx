        ...
        <div className="space-y-4">
            ...
            <div className="mt-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                    {[
                        "I am grateful for a person who helped me",
                        "I am grateful for something beautiful I saw",
                        "I am grateful for a challenge I overcame",
                        "I am grateful for a simple pleasure I enjoyed",
                        "I am grateful for something new I learned",
                        "I am grateful for an opportunity I have right now",
                        "I am grateful for the love and support around me",
                        "I am grateful for a moment of peace today",
                        "I am grateful for my ability to keep going despite difficulties",
                        "I am grateful for the small wins that make a big difference"
                    ]
                        .map((prompt, index) => (
                            <button
                                key={index}
